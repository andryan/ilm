...
public class StartScreen : MonoBehaviour {
	...
	void getScore ( string error, object result )
	{
		...
		else
		{
			...
			for (int i=0; i<list.Count; i++)
			{
				...
				{
					Main._highscoreFB = Convert.ToInt32( morehash["score"].ToString() );
					
					long tempScore = Main._highscoreFB;
					int wew1 = (int) (tempScore % 1000000);
					int wew2 = (int) (tempScore / 1000000);
					Debug.LogWarning( "score >>>>>>>>>>>> " + wew1 );
					Debug.LogWarning( "day >>>>>>>>>>>> " + wew2 );
				}
	...
	private void EnterStartScreen()
	{
		...
		*/
		...
		MoreGameObj.transform.localPosition = new Vector3(-415, 280, -2);
		/*
		...
		*/
		...
		MoreGameObj.transform.localScale = new Vector3(200,200,0.1f);
		/*
